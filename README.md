...
### 📅 미팅 일정 & 회의 녹음  
캘린더 기반 일정 관리 + 회의 녹음과 텍스트 변환 및 요약 기능이 통합된 협업 도구입니다.  
![미팅 일정 & 녹음](assets/미팅일정&녹음.gif)

### 📂 과제 관리  
과제 등록, 소과제 생성 및 마감일 설정, 과제 제출 및 제출 상태 확인이 가능합니다.  
...
### 💬 채팅  
실시간 그룹 채팅 기능 및 '찌르기' 알림 기능을 통해 그룹원에게 동기 부여 메시지를 전송할 수 있습니다.  
![chatting](https://github.com/user-attachments/assets/ab77caa6-0589-4ef5-a17f-3c07a9187dfe)


### 🔔 전체 알림 푸시  
미팅 등록, 과제 등록, 공지사항 등록, 채팅 알림 등 주요 이벤트 발생 시 푸시 알림이 전송됩니다.  
